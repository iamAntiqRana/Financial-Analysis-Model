...
def total_revenue(data: dict, financial_index):
    ...
    """
    # print(data['financials'][financial_index]['pnl']['lineItems']['net_revenue'])
...
def total_borrowing(data: dict, financial_index):
    ...
    """
    return data['financials'][financial_index]['bs']['liabilities']['short_term_borrowings']
...
def total_revenue_5cr_flag(data: dict, financial_index):
    ...
    """
    tot_revenue=total_revenue(data,financial_index)
    if tot_revenue>=50000000:
        return FLAGS.GREEN
    else:
        return FLAGS.RED
...
def iscr(data: dict, financial_index):
    ...
    num=data['financials'][financial_index]['pnl']['lineItems']['profit_before_interest_and_tax']
    num+=data['financials'][financial_index]['pnl']['lineItems']['depreciation']
    num+=1
    num=float(num)
    
    deno=data['financials'][financial_index]['pnl']['lineItems']['interest']+1
    deno=float(deno)
    return num/deno
...
def borrowing_to_revenue_flag(data: dict, financial_index):
    ...
    """
    tot_revenue=total_revenue(data,financial_index)
    tot_borrow=total_borrowing(data,financial_index)
    
    ratio=float(tot_borrow)/float(tot_revenue)
