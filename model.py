from rules import latest_financial_index, iscr_flag, total_revenue_5cr_flag, iscr, borrowing_to_revenue_flag,total_revenue
import json
...
def probe_model_5l_profit(data: dict):
    ...
    # print(total_revenue_5cr_flag_value)
